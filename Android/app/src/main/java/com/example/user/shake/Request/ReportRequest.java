...
public class ReportRequest extends StringRequest {
    ...
    public ReportRequest(String borrower,String bikecode, String real_return_time,String return_image_url,String contents,int requestCode ,Response.Listener<String> listener){
